      ...
      try {
        ...
        if (recipeImage && ( recipeImage.type === "image/png" || recipeImage.type === "image/jpg" || recipeImage.type === "image/jpeg")){
          ...
          const  imgData = await response.json()
            ...
            axios.put("http://localhost:3000/recipes/"+id,{ ...recipeData, image: imageURL }).
            then(res => {
              alert(`Recipe : ${res.data.title} update successfully`)
          ...
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-28">
            <div className="mx-auto max-w-full p-4 ">
              <h1 className="text-3xl font-bold mb-4">
                Edit une recette
                {
                  imagePreview ? (<img src={imagePreview && imagePreview} className="w-16 rounded-full" alt="Avatar" /> ) : (<img src={recipeData.image && recipeData.image} className="w-16 rounded-full" alt="Avatar" /> )
                }
              </h1>
              ...
              <div className="flex flex-row mb-4 ">
                <div className="basis-1/2 mx-2">
                  <label label htmlFor="origin" className="block text-gray-700 font-bold mb-2">
                    Origin
                  </label>
              ...
              "uploading ... " 
              :
              <button type="submit"  className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"  >Update recette</button>
            }
